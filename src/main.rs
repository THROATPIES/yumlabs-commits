...
mod user_interaction {
    ...
    pub fn prompt_target_directory() -> String {
        ...
        let answer = requestty::prompt_one(question).expect("Failed to get input");
        answer.as_string().expect("Invalid input type").to_string()
    }
    ...
    pub fn prompt_changes_type() -> String {
        ...
        let answer = requestty::prompt_one(question).expect("Failed to get input");
        answer.as_list_item().expect("Invalid choice").text.clone()
    }
    ...
    pub fn confirm_commit_message(commit_message: &str) -> bool {
        ...
        requestty::prompt_one(question).expect("Failed to get confirmation").as_bool().unwrap()
    }
...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    loop {
        let commit_message = llm_operations::generate_commit_message_from_llm(
            &changes,
            &nature_of_changes
        ).await?;
        
        if user_interaction::confirm_commit_message(&commit_message) {
